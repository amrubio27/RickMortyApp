package org.amrubio27.rickmortyapp.ui.core
...
val BackgroundPrimaryColor
    @Composable
    get() = if (isSystemInDarkTheme()) primaryBlack.copy(0.8f) else primaryWhite
...
val DefaultTextColor
    @Composable
    get() = if (isSystemInDarkTheme()) primaryWhite else primaryBlack
